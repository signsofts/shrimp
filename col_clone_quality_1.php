...
$ISP_ENDITEMKG = (int) $_POST["ISP_ENDITEMKG"];
$ISP_ENDPRICEKG = (float) $_POST["ISP_ENDPRICEKG"];
...
$sq = "UPDATE `shr_infoshrimp` SET `ISP_NOTE` = '$ISP_NOTE',
                                    `ISP_STATUS` = '1',
                                    `ISP_END` = '$ISP_END' ,
                                    `ISP_ENDITEMKG` = '$ISP_ENDITEMKG' ,
                                    `ISP_ENDPRICEKG` = '$ISP_ENDPRICEKG'
WHERE `shr_infoshrimp`.`ISP_ID` ='$ISP_ID';";


if (Database::query($sq)) {

    $ML_AMOUNT = $ISP_ENDITEMKG * (float) $ISP_ENDPRICEKG;
