                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <button type="button" class="btn btn-primary" data-bs-toggle="modal"
                                            data-bs-target="#modalEdit-<?php echo $item->FT_ID; ?>"> แก้ไข </button>
 

                                        <!-- เมื่อคลิกเรียนใช้ Fn deleteBtn()-->
                                        <button type="button" class="btn btn-secondary"
                                            onclick="deleteBtn('<?php echo $item->FT_ID; ?>')"> ลบ </button>

                                    </td>

                                    <!-- modal แก้ไข ข้อมูล อาหาร  -->
                                    <div class="modal fade" id="modalEdit-<?php echo $item->FT_ID; ?>" tabindex="-1"
                                        aria-labelledby="modalAddLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-lg">
                                            <div class="modal-content">
                                                <form id="form-edit-<?php echo $item->FT_ID; ?>"
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input type="hidden" class="form-control border-0" name="FT_ID"
                                                            placeholder="" value="<?php echo $item->FT_ID; ?>">
                                                        <div class="row g-3">
                                                            <div class="col-12 col-sm-12">
                                                                <label for="">ชื่ออาหาร</label>
                                                                <input type="text" class="form-control border-0"
                                                                    name="FT_NAME" placeholder=""
                                                                    value="<?php echo $item->FT_NAME; ?>" required
                                                                    style="height: 55px;">
                                                            </div>
                                                            <div class="col-12 col-sm-12">
                                                                <label for="">เบอร์อาหาร</label>
                                                                <input type="number" class="form-control border-0"
                                                                    name="FT_NUMBER" placeholder=""
                                                                    value="<?php echo $item->FT_NUMBER; ?>" required
                                                                    style="height: 55px;">
                                                            </div>
                                                        </div>
                                                    </div>
                ...
                <form id="form-add" action="javascript:void(0);" method="post">
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row g-3">
                            <div class="col-12 col-sm-12">
                                <label for="">ชื่ออาหาร</label>
                                <input type="text" class="form-control border-0" name="FT_NAME" placeholder="" value=""
                                    required style="height: 55px;">
                            </div>
                            <div class="col-12 col-sm-12">
                                <label for="">เบอร์อาหาร</label>
                                <input type="number" class="form-control border-0" name="FT_NUMBER" placeholder=""
                                    value="" required style="height: 55px;">
                            </div>
